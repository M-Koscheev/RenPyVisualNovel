...
label eleventh_scene_first_second:
    ...
    Zanuda "Это не просто информатика, это разработка игр."

    Zanuda "Программирование, в крайнем случае."
...
label eleventh_scene_second_first:
    ...
    Clown "Слушай, может ну его?"
    
    Clown "Чё-то вообще мутное. Погнали в бравл лучше?"
...
label eleventh_scene_second_second:
    ...
    Zanuda "А меня Мефодий. Хахахахах вот это я пошутил. Я Глеб"
...
label fourteen_second:
    ...
    Zanuda "Ого, и правда. Ты сильно прибавил в программировании за то время, что мы сидим вместе."

    Zanuda "У тебя какая-то бешеная мотивация?"
    ...
    Zanuda "Ты серьёзно? Ты из-за неё в таком темпе разбираешь это всё?"

    Kirill "Ну да, а чё?"

    Zanuda "Так у тебя нет шансов."

    Zanuda "Вряд ли спустя столько времени она такая:"

    Zanuda "«Так, парень, с которым я сижу уже больше месяца и нашла общий язык, я от тебя ухожу..."

    Zanuda "...к мальчику, на которого в первый раз обратила внимания из-за того, что он ответил самый первый на вопросы нашей училки и научился программировать»."

    Kirill "Ну, это мы ещё посмотрим, мистер хейтер."

    Zanuda "Если так произойдёт, то я выполняю твоё желание."
    ...
    Zanuda "(До сих пор в шоке) Да, давно хотел."

    Zanuda "Мы с Кириллом так и думали, что он хитрит."
